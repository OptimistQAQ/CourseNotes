...
<%@ page import="bean.*" %>
<%@ page import="util.*" %>
<jsp:useBean id="myIndentlist" scope="page" class="service.manage_buybook" />
<jsp:useBean id="mybook" scope="page" class="service.manage_book" />
...
-->
 ...
 <% if(!mesg.equals("")){
		...
		out.println(mesg);
	%>
		<p>书店图书订单<%= Ident.getOrderId() %>&nbsp;清单:</p>
