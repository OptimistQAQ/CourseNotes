...
<tr>
	<td align="center" width="77%">
		<p>
			<br> <font size="3"><b>添加新的图书资料</b></font>
		</p> <% if(!mesg.equals("")){
			out.println(mesg);
		  }%>
		<form name="form1" method="post" action="adm_addbook.jsp">
			<table width="90%" border="0" cellspacing="1" cellpadding="1">
				...
				<tr>
					...
					<td width="65%"><input type="File" name="picture" class=box>
					</td>
				</tr>
				<tr>
					<td align="right" width="35%" valign="top">图书简介：</td>
					<td width="65%"><textarea name="content" cols="40" rows="6"></textarea>
					</td>
				</tr>
				<tr>
