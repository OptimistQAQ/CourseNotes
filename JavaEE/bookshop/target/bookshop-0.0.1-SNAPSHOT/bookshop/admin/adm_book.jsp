...
<tr>
	<td align="center">网上书店现有图书资料</td>
</tr>
<tr>
	<table width="778" border="1" cellspacing="2" bgcolor="#E4EDFB"
...
%>
		<tr>
			...
			<td><a href="#"
				onclick="openScript('book_detail.jsp?bookid=<%= bk.getId() %>','sbook',450,500);"><%= bk.getBookName() %></a></td>
			...
			<td align="center"><a
				href="book_modify.jsp?id=<%= bk.getId() %>">修改</a>&nbsp;&nbsp;<a
				href="adm_book.jsp?action=del&page=<%= pages %>&id=<%= bk.getId() %>"
	...
	<table width="778" border="0" cellspacing="1" cellpadding="1"
		bgcolor="#E4EDFB" align="center">
		<tr>
			<td align="right">当前页第<%= book_list.getPage() %>页 <a
				href="adm_book.jsp">首页</a>&nbsp; <% if (book_list.getPage()>1) {%><a
				href="booklist.jsp?page=<%= book_list.getPage()-1 %>">上一页</a>&nbsp;<% } %>
				<% if (book_list.getPage()<book_list.getPageCount()) {%><a
				href="adm_book.jsp?page=<%= book_list.getPage()+1 %>">下一页</a>&nbsp;<% } %>
				<a href="adm_book.jsp?page=<%= book_list.getPageCount() %>">末页</a>&nbsp;
			</td>
		</tr>
	</table>
