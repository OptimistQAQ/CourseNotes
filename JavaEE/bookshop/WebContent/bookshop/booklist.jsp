...
<table width="778">
	<tr>
		...
		<td width="600" valign="top">
			<p align="center">
				<b><font color="#000000">网上</font><font color="#000000">书店图书<%=classname%>列表</font>
				</b>
			</p>
			<%
				if (!keyword.equals("")){
...
<% if (book_list.book_search(request)) {
	...
	%>
		<tr>
			...
			<td align="center">
				<a href="#" onclick="openScript('buybook.jsp?bookid=<%=bk.getId()%>','pur',300,250)">购买</a>&nbsp;
				<a href="#" onclick="openScript('bookdetail.jsp?bookid=<%=bk.getId()%>','show',400,500)">详细资料</a>
				</td>
		</tr>
	<%
				   		  }
	                    	...
	                    	if (keyword.equals("")) {
								...
								out.println("<tr><td align='center' colspan=6>&nbsp;没有你要查找的&nbsp;"
												+ keyword + "&nbsp;相关图书</td></tr>");
							}
	                    }
	           } else {
	                	  out.println("<tr><td align='center' colspan=6>&nbsp;此类图书不存在</td></tr> ");
	                  }
%>
</table>
