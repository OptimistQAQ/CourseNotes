...
<body text="#000000" onLoad="javascript:window.focus();">
	<div align="center">
		...
		<table width="95%" border="1" cellspacing="1" cellpadding="1"
			...
			<tr>
				<td align=right width=100>注册来源</td>
				<td><%= userinfo.getRegIpAddress() %></td>
			</tr>
			<tr>
		...
		<br> <a href="user_modify.jsp?userid=<%= userinfo.getId()%>">修改</a>&nbsp;&nbsp;
		<a href="user_detail.jsp?action=del&userid=<%=userinfo.getId() %>"
			onClick="return(confirm('你真的要删除这个用户?'))">删除</a><br>
		<br>
		<%}%>
		<br>
		<p>
