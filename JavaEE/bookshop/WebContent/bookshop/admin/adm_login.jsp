...
<%@ page session="true"%>
<jsp:useBean id="alogin" scope="page" class="service.manage_login" />
<%
String mesg = "";
				...
				<td align="center">
					<form name="form1" method="post" action="adm_login.jsp">
						<table width="360" border="0" cellspacing="2" cellpadding="2"
							bgcolor="#E4EDFB" bordercolor="#66CCFF" style="font-size: 9pt">
							<tr align="center">
								<td colspan="2">
									<h3>
										<br> <font color="#FF0000">书店管理系统</font>
									</h3>
									<p>
										&nbsp;<% if (!mesg.equals("")){
						out.println(mesg);}%>
							...
							<tr align="center">
								<td colspan="2"><input type="submit" name="Submit"
									value="登录" onclick="javascript:return(checkform());"> <a>&nbsp;&nbsp;&nbsp;&nbsp;</a>
							...
							<tr align="center">
								<td colspan="2"><A HREF="../login.jsp">返回首页</A></td>
							</tr>
						</table>
					</form>
					<p>&nbsp;</p>
