...
<jsp:useBean id="shop" scope="page" class="service.manage_shopcart" />
<%
String mesg = "";
...
<body text="#000000" onLoad="javascript:window.focus();">
	...
	<div style="padding-top: 20px;" align="center">
		<p>
			网上书店欢迎你<font color="#CC0066">选购图书</font>！
		</p>
		<% if(!mesg.equals("")){
		out.println(mesg);
	  } else {
	...
	%>
		<table width="90%" border="0" cellspacing="2" cellpadding="1">
			<form name="form1" method="post" action="buybook.jsp">
				...
				<tr align="center">
					<td>你想要的数量： <input type="text" name="amount" maxlength="4"
						size="3" value="1"> 本
					</td>
				</tr>
				<tr align="center">
					<td><input type="hidden" name="bookid" value="<%=Id %>">
						<input type="submit" name="Submit" value="购 买"
						onClick="return(check());"> <input type="reset"
						name="Reset" value="取 消"></td>
				</tr>
				<tr align="center">
					<td><a href="#"
						onClick="openScript('bookdetail.jsp?bookid=<%= Id %>','show',400,450)">查看详细资料</a>
					</td>
				</tr>
			</form>
		</table>
