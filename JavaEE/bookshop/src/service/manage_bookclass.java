...
public class manage_bookclass extends DataBase {
	...
	public String getBookClassSql() {
		sqlStr = "select * from getBookClass";
		return sqlStr;
	}
	...
	public boolean getRequest(javax.servlet.http.HttpServletRequest newrequest) {
		...
		try {
			...
			String str = request.getParameter("bookclassname");
			String bookclassname = new String(str.getBytes("ISO-8859-1"),"GBK");
			if (bookclassname == null || bookclassname.equals("")) {
				bookclassname = "";
				flag = false;
			}
			System.out.print(bookclassname);
	...
	public boolean insert() throws Exception {
		sqlStr = "insert into getBookClass (classname) values ('";
	...
	public boolean delete(int aid) throws Exception {
		sqlStr = "delete from getBookClass where id = " + aid;
		try {
			DataBase db = new DataBase();
			Connection conn = db.connect();
			stmt = conn.createStatement();
