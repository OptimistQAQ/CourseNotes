...
public class manage_book extends DataBase {
	...
	private Vector<book> booklist; // 显示图书列表向量数组
	...
	public String getSql() {
		sqlStr = "select id,classname from book";
		return sqlStr;
	}
	...
	public boolean book_search(HttpServletRequest res) throws Exception {
		...
		sqlStr = "select * from class_book a";
