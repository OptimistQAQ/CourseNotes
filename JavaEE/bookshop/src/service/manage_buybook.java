...
public class manage_buybook extends DataBase {
   ...
   public manage_buybook() {
    ...
    public boolean getOrder(long userid) {
      sqlStr = "select * from `order` where userid = '" + userid +
          "' order by id desc";
      try {
    ...
    public boolean getSinggleOrder(String order_id) {
      sqlStr = "select * from `order` where orderId = '" + order_id +
          "' ";
      try {
        DataBase db = new DataBase();
                  Connection conn=db.connect();
    ...
    public boolean getAllorder(String order_id) {
      sqlStr = "select * from allorders where orderId = '" + order_id + "'";
      try {
        DataBase db = new DataBase();
                  Connection conn=db.connect();
                  stmt = conn.createStatement ();
    ...
    public boolean update(HttpServletRequest res) {
      ...
      try {
        ...
        sqlStr = "update `order` set IsPayoff = '" + payoff + "',IsSales='" +
    ...
    public boolean delete(long id) {
      try {
        DataBase db = new DataBase();
                  Connection conn=db.connect();
                  stmt = conn.createStatement ();
        sqlStr = "delete from allorders where id =" + id;
        stmt.execute(sqlStr);
        /*sqlStr = "delete from `order` where id= " + id;
        stmt.execute(sqlStr);*/
